...
> controlPipeline(
    ...
    std::tuple<
        ...
        Eigen::Vector4d,
        Eigen::Vector4d
    > FTG_data = footTrajectories(time, frequencies, config);
    ...
    for (int i = 0; i < 4; i++) 
    {
        ...
        auto leg_joint_angles = solveLegIK(right_leg, r, config);
